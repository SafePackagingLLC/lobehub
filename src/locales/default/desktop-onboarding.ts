export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using BridgePoint AI Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve BridgePoint AI. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve BridgePoint AI',
  ...
  'screen5.actions.signInCloud': 'Sign in to BridgePoint AI Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your BridgePoint AI Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'BridgePoint AI Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own BridgePoint AI server instance',
