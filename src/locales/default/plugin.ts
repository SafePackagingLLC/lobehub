export default {
  ...
  'protocolInstall.official.badge': 'BridgePoint AI Official Skill',
  'protocolInstall.official.description':
    'Official BridgePoint AI Skill, verified and security-checked.',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'BridgePoint AI Skills',
