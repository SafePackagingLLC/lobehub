export default {
  ...
  'createGuide.func1.title': 'Submit in BridgePoint AI',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the BridgePoint AI Community.',
  'footer.title': 'Share your creation on BridgePoint AI Community today',
  ...
  'models.providerInfo.apiTooltip':
    'BridgePoint AI supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'BridgePoint AI Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on BridgePoint AI',
  ...
  'skills.details.sidebar.platform.layout.lobehub':
    'Skills are managed by BridgePoint AI automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the BridgePoint AI marketplace with one click.',
