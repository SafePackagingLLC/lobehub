export default {
  ...
  'navigation.lobehub': 'BridgePoint AI',
  ...
  'remoteServer.configDesc':
    'Connect to the remote BridgePoint AI server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'BridgePoint AI Cloud',
