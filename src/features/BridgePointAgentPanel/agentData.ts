...
export const AGENTS: BPAgent[] = [
  ...
  },
  {
    behavior: 'minimal',
    category: 'Engineering',
    description: 'Engineering calculations, material selection, and process optimization',
    emoji: '⚙️',
  ...
  },
  {
    behavior: 'minimal',
    category: 'Engineering',
    description: 'Interpret P&IDs, electrical schematics, and hydraulic/pneumatic diagrams',
    emoji: '🔌',
    id: 'pid-schematic-analyst',
    model: 'anthropic/claude-sonnet-4',
    name: 'P&ID / Schematic Analyst',
    provider: 'openrouter',
    temperature: 0.3,
  },
  {
