...
export const LOBE_CHAT_CLOUD = 'BridgePoint AI Cloud';

export const BRANDING_NAME = 'BridgePoint AI';
export const BRANDING_LOGO_URL = '';

export const ORG_NAME = 'BridgePoint AI';
...
export const SOCIAL_URL = {
  discord: undefined,
  github: 'https://github.com/SafePackagingLLC',
  medium: undefined,
  x: undefined,
  youtube: undefined,
};
...
export const BRANDING_PROVIDER = 'bridgepoint-ai';
